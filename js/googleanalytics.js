...
;(function () {
  ...
  */
  ...
  ke.ca = 'dataLayer'
  ke.ai =
    'ChEI8K3ZoQYQrJSOsauotMicARImAMJmGmhvSn0KY44yCViwP+5j1x63viv331TdHH3sytcYiWaW+9EaAjRn'
  var ne = {
      __cl: !0,
      __ecl: !0,
      __ehl: !0,
  ...
  var oi = { UA: 1, AW: 2, DC: 3, G: 4, GF: 5, GT: 12, GTM: 14, HA: 6, MC: 7 },
    pi = function (a) {
  ...
  var dj = function (a) {
    ...
    ej =
      ...
      0 <= z.location.search.indexOf('&gtm_latency=')
  var fj = { sampleRate: '0.005000', Vh: '', Uh: Number('5'), fl: Number('') },
    gj
  if (!(gj = ej)) {
    var hj = Math.random(),
      ij = fj.sampleRate
        ...
        yk(function () {
          k(d, function (f, g) {
            ...
            if (l.length) {
              var m = l[0],
                n = Kk(m),
                p = 0 !== Mk(m.split('.')).length ? m.split('.').slice(3) : [],
                q = {},
                t
  ...
  var fl = function (a, b, c) {
      ...
      z[a.functionName] = d
      if (a.be)
        for (var e = 0; e < a.be.length; e++) z[a.be[e]] = z[a.be[e]] || el()
                  ...
                  if (d) ml(d, n[w], r, { ab: u, options: t })
                    ...
                    if (nl()) ml([a], n[w], r || 'US', { ab: u })
                      ...
                      if (x) {
                        ...
                        var B = fl(hl, A, y),
                          D = {}
                        void 0 !== A.ab ? (D.receiver = A.ab) : (D.replace = x)
                        D.ga_wpid = y
                        D.destination = x
                        B(2, Ea(), D)
                      }
  ...
  var hm = !1
  function im() {
    if (gm('join-ad-interest-group') && qa(Ab.joinAdInterestGroup)) return !0
    hm || (Di(), (hm = !0))
  ...
  var Nq = {
      ...
      event: function (a, b) {
        ...
        if (!(2 > a.length) && h(c)) {
          ...
          var q = d,
            t = q && q[N.g.Eb]
          void 0 === t && ((t = Le(N.g.Eb, 2)), void 0 === t && (t = 'default'))
          if (h(t) || sa(t)) {
  ...
  var Br = function () {
      ...
      b.push = function () {
        ...
        if (0 < le.SANDBOXED_JS_SEMAPHORE) {
          g = []
          for (var l = 0; l < arguments.length; l++) g[l] = new kr(arguments[l])
    ...
    Lv = function (a, b, c) {
      ...
      if (qa(l)) {
        ...
        var p = function (F) {
          ...
          q = function (F) {
            ...
            if (W) {
              ...
              if ('promo_click' === S || 'promo_view' === S || (K && W.cd)) {
                var M = W.cd
                L('ec:addPromo', M)
          ...
          t = function (F) {
            if (F) {
              var L = {}
              if (Yb(F))
                for (var K in Gv) Gv.hasOwnProperty(K) && Hv(Gv[K], K, F[K], L)
              Cv(L, y)
              p('require', 'linkid', L)
            }
          },
          r = function () {
            if (di()) {
              ...
              var F = Q(c, N.g.Gi)
              F &&
                (p('require', F, { dataLayer: ke.ca }), p('require', 'render'))
            }
          },
          u = zv(n, b, c),
          v = function (F, L, K) {
        ...
        if (u.createOnlyFields[N.g.yb] && !c.D) {
          var w =
            te || ve ? qo(u.createOnlyFields[N.g.yb], '/analytics.js') : void 0
          w && (g = w)
        }
  ...
  var Kv,
      ...
      for (var t = !c.D, r = Nl(c), u = 0; u < r.length; ++u) {
        ...
        if (c.D) {
          ...
          if (Zv.hasOwnProperty(v)) Hv(Zv[v], v, y, e)
            ...
            v === N.g.Ia && 0 > r.indexOf(N.g.Rb) && (l.cookieName = y + '_ga')
          P(96) &&
            Sv[v] &&
    ...
    Fv = function (a, b) {
      ...
      var q = null,
        t = d(N.g.xi)
      if (a === N.g.Ga || a === N.g.qc) q = { action: a, Ra: c(), Ib: Ov(e) }
      ...
      else if (a === N.g.sb) q = { action: 'promo_view', cd: Ov(t) || Ov(e) }
      else if (('select_content' === a && t && 0 < t.length) || a === N.g.Pb)
  ...
  ;(function (a) {
    ...
    if (!z['__TAGGY_INSTALLED']) {
      ...
      c &&
        ((z['__TAGGY_INSTALLED'] = !0), Hb('https://cct.google/taggy/agent.js'))
    }
    if (xe) a()
    else {
      var f = function (u) {
    ...
    if (R.jb ? le['ctid_' + R.jb] : le[R.C]) {
      ...
      for (var l = c.predicates || [], m = 0; m < l.length; m++) yc.push(l[m])
